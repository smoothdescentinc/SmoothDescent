      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-brand-dark/70 max-w-2xl mx-auto">
            Everything you need to know about ordering, using, and getting results from Metabolic Defense products.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
            ...
            <a href="mailto:support@metabolicdefense.com" className="font-bold text-brand-primary hover:text-brand-accent transition-colors border-b border-brand-primary/20 hover:border-brand-primary">
                Contact Support
            </a>
        </div>
